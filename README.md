...
contains the source distribution for `jq` 1.8.2 and [`oniguruma`][2] 6.9.10.
...
package is written into the project root with the name `jq-1.8.2.pkg`.  
...
if notarization succeeds.  Use the command:
        ...
        $ xcrun stapler validate --verbose jq-1.8.2.pkg
