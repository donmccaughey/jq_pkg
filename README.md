...
contains the source distribution for `jq` 1.8.1 and [`oniguruma`][2] 6.9.10.
...
required to generate the credentials needed to sign and notarize.  The
[GitHub CLI][4] is used to publish package releases to GitHub.
...
[5]: https://github.com/donmccaughey/jq_pkg/blob/master/Makefile
...
package is written into the project root with the name `jq-1.8.1.pkg`.  
...
if notarization succeeds.  Use the command:
        ...
        $ xcrun stapler validate --verbose jq-1.8.1.pkg
